...
"Mozilla/5.0 (Macintosh; Intel Mac OS X 11_0_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.90 Safari/537.36",
...
int socket_connect(char *host, in_port_t port) 
{
	...
	setsockopt(sock, IPPROTO_UDP, TCP_NODELAY, (const char *)&on, sizeof(int));
	if (sock == -1) return 0;
